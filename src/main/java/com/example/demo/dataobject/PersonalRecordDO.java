...
public class PersonalRecordDO implements Serializable {
    ...
    public PersonalRecord toModel() {
        PersonalRecord personalRecord = new PersonalRecord();
        personalRecord.setId(getId());
        personalRecord.setUserId(getUserId());
        personalRecord.setKd(getKd());
        personalRecord.setPoints(getPoints());
        personalRecord.setEliminateNum(getEliminateNum());
        personalRecord.setPlayNum(getPlayNum());
        personalRecord.setWinTimes(getWinTimes());
        personalRecord.setTopTenTimes(getTopTenTimes());
        personalRecord.setGmtCreated(getGmtCreated());
        personalRecord.setGmtModified(getGmtModified());
